defmodule QRClassWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QRClassWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QRClassWeb.Gettext, "errors", msg, opts)
    end
  end
